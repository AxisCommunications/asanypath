...
class CloudPathMixin(CommonPurePathMixin):
    ...
    async def _server_side_copy(
        ...
        *,
        ...
        kwargs = {
            ...
            "options_json": (
                msgspec.json.encode(destination_backend_options).decode()
    ...
    async def read_text(
        ...
        text = (await self.read_bytes()).decode(
    ...
    async def walk(
        ...
        ``follow_symlinks`` is accepted for API parity; cloud objects have no symlinks.
        """
        try:
