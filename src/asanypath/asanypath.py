...
# Flavors whose abstract-method implementation has been validated once.
_VALIDATED_FLAVORS: set[type] = set()
...
class AsAnyPurePath(ABC):
    ...
    def __new__(
        ...
        **kwargs,
        ...
        # Validate a flavor's abstract-method coverage once, then memoize:
        # dir()+set-diff is ~half the per-construction cost otherwise.
        if flavor not in _VALIDATED_FLAVORS:
